...
public class ListaVooCompleto extends ActionBarActivity {
    ListView listView;
    Activity atividade;
    public final static String VOO = "com.example.felipe.projetoaeronave_arqdesis.VOO";
    Voo[] voos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voos = especialista.listarVoos(origem, destino).toArray(new Voo[0]);
        String[] lista = null;
